export const data = [
  ...
  },
  {
    ...
    "values": [
      ...
      {
        "name": "TOJSON",
        "autoCompleteValue": "TOJSON(",
        "description": "Serializes any value into a JSON string. The inverse of `PARSEJSON`.<br/>Accepts 1 argument: the value to serialize.",
        "examples": [
          "Contacts -> MAP([Name, Email]) -> TOJSON() // A table of values, as JSON"
        ],
        "icon": "utility:data_mapping"
      },
      {
