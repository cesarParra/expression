export const data = [
  {
    ...
    "values": [
      ...
      },
      {
        ...
        "description": "Creates a ma by associating each element of the input list with a key<br/>generated by the given expression.<br/>Accepts 2 arguments: the list to evaluate and the expression to evaluate.<br/>Provides the following special variables in the inner expression:<br/>- `$current` (the current item being iterated over).",
        "examples": [
