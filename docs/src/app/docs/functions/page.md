...
Creates a map by associating each element of the input list with a key generated by the given expression.

Accepts 2 arguments: the list to associate and the expression to evaluate.
