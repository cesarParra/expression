...
function PageLink({
  ...
  return (
    <div {...props}>
      <dt className="font-display text-sm font-medium text-stone-900 dark:text-white">
      ...
      <dd className="mt-1">
        <Link
          href={href}
          className={clsx(
            'flex items-center gap-x-1 text-base font-semibold text-stone-500 hover:text-stone-600 dark:text-stone-400 dark:hover:text-stone-300',
