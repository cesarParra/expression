...
export function QuickLink({
  ...
  return (
    <div className="group relative rounded-xl border border-stone-200 dark:border-stone-800">
      <div className="absolute -inset-px rounded-xl border-2 border-transparent opacity-0 [background:linear-gradient(var(--quick-links-hover-bg,theme(colors.orange.50)),var(--quick-links-hover-bg,theme(colors.orange.50)))_padding-box,linear-gradient(to_top,theme(colors.amber.400),theme(colors.yellow.400),theme(colors.orange.500))_border-box] group-hover:opacity-100 dark:[--quick-links-hover-bg:theme(colors.stone.800)]" />
